    ...
    <section class="notifications">
        ...
        <div class="col-lg-10 col-sm-12 mx-auto">
            <ul class="nav nav-tabs rounded-0" role="tablist">
                ...
                <li class="nav-item ml-0">
                    <a class="nav-link waves-light" data-toggle="tab" role="tab" href="#prnotifs"
                        aria-selected="false" aria-controls="prnotifs">Projects
                        <span id="projAlert" runat="server" visible="false" class="font-weight-bold text-danger">!</span>
                    </a>
                </li>
                <%if (user().type == "client") %>
                <%{ %>
            ...
            <div class="tab-content p-0">
                ...
                <div class="tab-pane fade" id="prnotifs" role="tabpanel" aria-labelledby="prnotifs">
                    <div class="row justify-content-center mx-auto p-2 col-12">
                        <div runat="server" id="projClear" class="col-12 row justify-content-end mx-auto" visible="false">
                            <asp:LinkButton runat="server" CssClass="ml-auto btn btn-secondary" CommandArgument="project,project_like" OnCommand="clearAll">
                                Clear All
                            </asp:LinkButton>
                        </div>
                        <div class="text-center mt-2">
                            <h4>
                                <asp:Label runat="server" ID="projErr" Text="No Notifications"></asp:Label>
                            </h4>
                        </div>
                        <asp:Repeater runat="server" ID="projects" OnItemCommand="common_ItemCommand">
                            <ItemTemplate>
                                <div id="notif<%#Eval("Id") %>" class="col-12 row justify-content-between z-depth-1 my-2">
                                    <div class="col-8 row mx-auto my-3">
                                        <div class="pl-2 align-self-center pt-1">
                                            <h5>
                                                <asp:LinkButton runat="server" CommandName="viewprofile" CommandArgument='<%#Eval("uid") %>'><%#Eval("username") %></asp:LinkButton>
                                                commented on  
                                                <asp:LinkButton runat="server" CommandName="viewproject" CommandArgument='<%#Eval("pid") %>'><%#Eval("title") %></asp:LinkButton>
                                            </h5>
                                        </div>
                                    </div>
                                    <div class="col-2 align-self-center pt-2 row justify-content-end mx-auto">
                        ...
                        <asp:Repeater runat="server" ID="projLikes" OnItemCommand="common_ItemCommand">
                            <ItemTemplate>
                                <div id="notif<%#Eval("Id") %>" class="col-12 row justify-content-between z-depth-1 my-2">
                                    <div class="col-8 row mx-auto my-3">
                                        <div class="pl-2 align-self-center pt-1">
